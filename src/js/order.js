...
form.addEventListener('submit', (e) => {
    ...
    let url = `https://api.whatsapp.com/send?phone=62882319928404&text=*Halo%20Admin,%20Saya%20Mau%20TopUp%20Games*.%0A%0ADetail%20Pesanan%20%3A%0A%0AUser%20ID%20%3A%20${userId}%0ANickname%20%3A%20${userName}%0AJumlah%20Pembelian%20%3A%20${inputNominal}%0APembayaran%20%3A%20${paymentMethod}%0A%0AOrder Via Web KimStore`
    window.open(url);
})